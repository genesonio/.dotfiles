...
export PATH=$PATH:/home/genesio/go/bin
...
cdd() {
    selected=$(find ~/Docker -mindepth 1 -maxdepth 1 -type d | fzf --preview 'ls {}' --query "$1" --print0 --select-1)
    cd $selected
}
...
ngroks() {
  ngrok http --domain=large-squirrel-allowed.ngrok-free.app 3000
}
